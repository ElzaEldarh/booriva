    ...
    return(
        <div className={styles.storeSection}>
            <div className={styles.storeSectionLeft}>
                <div className={styles.storeCaption}>BOORIVA<br/> STORE</div>
                <div className={styles.storeAdress}>г.Грозный ул.Магазинная <br/> Ежедневно с 11:00 до 21:00</div>
            ...
            <div className={styles.storeInfo}>Ты можешь заказать <br/>примерку  понравившейся<br/>вещи или просто <br/>заглянуть, гуляя по Подолу,<br/>и примерять что-то<br/>из в наличии</div>
            </div>
