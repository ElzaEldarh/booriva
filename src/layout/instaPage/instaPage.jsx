            ...
            {/* <div className="wrapper"> */}
                <div className={styles.instaPage}>
                    <div className={styles.leftSection}>
                        ...
                        <div className={styles.leftSectionText}>Мы в экстазе, когда ты нас отмечаешь)
                        Отмечай плз чаще</div>
                    ...
                    <div className={styles.rightSection}>
                        ...
                        <div className={styles.rightSectionText}>Ставь тэг чтобы быть в нашей тусовке.</div>
                    {/* </div> */}
                </div>
            </div>
        </div>
